...
export const CAREER_LEVEL_META: Record<CareerLevel, { bg: string; color: string; border: string }> = {
    ...
    "BASIC 3": { bg: "bg-sky-50", color: "text-sky-600", border: "border-sky-200" },
    "BASIC 2": { bg: "bg-sky-100", color: "text-sky-700", border: "border-sky-300" },
    "BASIC 1": { bg: "bg-blue-100", color: "text-blue-700", border: "border-blue-300" },
    "KNOWLEDGE 3": { bg: "bg-violet-50", color: "text-violet-600", border: "border-violet-200" },
    "KNOWLEDGE 2": { bg: "bg-violet-100", color: "text-violet-700", border: "border-violet-300" },
    "KNOWLEDGE 1": { bg: "bg-purple-100", color: "text-purple-700", border: "border-purple-300" },
    "AHLI / SPECIALIST": { bg: "bg-amber-100", color: "text-amber-700", border: "border-amber-300" },
};
