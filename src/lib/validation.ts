...
export const createPaymentSchema = z.object({
    ...
    laptop_id: z.string().min(1, "Laptop wajib dipilih"),
    laptop_name: z.string(),
    unit_id: z.string(),
    ...
    amount: z.number({ error: "Harga wajib diisi" }).min(1000, "Harga minimal Rp1.000"),
    payment_method: z.enum(["QRIS", "TRANSFER", "CASH", "SHOPEE_PAY", "TOKOPEDIA_PAY", "COD"]),
