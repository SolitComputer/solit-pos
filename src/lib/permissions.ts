...
export const ROUTE_PERMISSIONS: Record<string, UserRole[]> = {
  ...
  "/dashboard/laptops":          ["ADMIN", "PENGELOLA_BARANG"],
  ...
  "/api/laptops":                ["ADMIN", "PENGELOLA_BARANG", "KEPALA_SALES", "CREW_SALES"],
...
export const PERMISSIONS = {
  ...
  VIEW_BARCODE:       ["ADMIN", "KEPALA_SALES", "CREW_SALES", "PENGELOLA_BARANG"]     as UserRole[],
  ...
  VIEW_UNITS:         ["ADMIN", "KEPALA_SALES", "CREW_SALES", "PENGELOLA_BARANG"]     as UserRole[],
};
