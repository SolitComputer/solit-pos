...
// src/lib/permissions.ts - Tambahkan KEPALA_MARKETING

export const PERMISSIONS = {
  VIEW_DASHBOARD:      ["ADMIN", "ACCOUNTING", "KEPALA_SALES", "CREW_SALES", "PENGELOLA_BARANG", "PENGANTARAN", "KEBERSIHAN", "KEPALA_MARKETING", "MARKETING"] as UserRole[],

  VIEW_FINANCIALS:     ["ADMIN", "ACCOUNTING"] as UserRole[],
  VIEW_REPORTS:        ["ADMIN", "ACCOUNTING"] as UserRole[],

  VIEW_TRANSACTIONS:   ["ADMIN", "KEPALA_SALES", "ACCOUNTING", "CREW_SALES", "PENGELOLA_BARANG", "PENGANTARAN", "KEBERSIHAN", "KEPALA_MARKETING", "MARKETING"] as UserRole[],
  ...
  // ✅ TAMBAHKAN KEPALA_MARKETING ke VIEW_LAPTOPS
  ...
  // ✅ TAMBAHKAN KEPALA_MARKETING ke VIEW_BARCODE
  ...
  // ✅ TAMBAHKAN KEPALA_MARKETING ke VIEW_UNITS
  ...
  // ✅ TAMBAHKAN KEPALA_MARKETING ke VIEW_WARRANTY
  ...
  // ✅ TAMBAHKAN KEPALA_MARKETING ke VIEW_READY_LAPTOPS
