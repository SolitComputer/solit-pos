              ...
              return (
                <div key={tx.id} className="px-3 py-2 flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <p className="text-[11px] font-semibold text-gray-700 truncate">{tx.customer_name}</p>
                    <p className="text-[10px] text-gray-400 font-mono">{tx.invoice_number}</p>
                    {tx.sales_name && (
            ...
            <div className="p-5 sm:p-6 space-y-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-3 border border-gray-200">
                  <p className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Hari Ini</p>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-3 border border-blue-200">
                  <p className="text-[10px] text-blue-700 font-semibold uppercase tracking-wider">
                    {canSeeFinancials ? "Profit Hari Ini" : "Tahun Ini"}
                  </p>
                  <p className="font-bold text-sm text-blue-900 mt-1">
                    {canSeeFinancials
                      ? fmtShort(data.today.profit)
                      : `${data.yearly[0]?.count ?? 0} trx`}
                  </p>
                </div>
              </div>
