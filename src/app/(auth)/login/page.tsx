  ...
  const handleSetPassword = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/auth/set-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ userId, password: newPw, confirmPassword: confirmPw }),
      });
      const result = await res.json();
      ...
      <div className="relative w-full max-w-lg z-10">
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black/40 hover:border-white/20 transition-all duration-500">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-white text-3xl font-bold mt-5 tracking-tight">Solit POS</h1>
            <p className="text-white/40 text-sm mt-2">
              {stage === "login" ? "Akses sistem terintegrasi" : "Buat password Anda"}
            </p>
          </div>
          ...
          {stage === "login" && (
            <>
              ...
              <div className="space-y-5">
                ...
                <button onClick={handleLogin} disabled={loading} className="relative w-full group mt-4">
            ...
            <>
              <div className="mb-6 px-4 py-3 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                <p className="text-blue-400 text-sm">
                  Selamat datang! Akun Anda sudah dibuat oleh admin. Silakan buat password untuk pertama kali.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-white/50 text-xs font-semibold mb-2 block uppercase tracking-wider">Password Baru</label>
                  <div className="relative">
                    <input
                ...
                <div>
                  <label className="text-white/50 text-xs font-semibold mb-2 block uppercase tracking-wider">Konfirmasi Password</label>
                  <input
                    type="password"
                ...
                <button onClick={handleSetPassword} disabled={pwLoading} className="relative w-full group mt-2">
