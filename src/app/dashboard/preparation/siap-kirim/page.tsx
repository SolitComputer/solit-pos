        ...
        <div className="max-w-5xl mx-auto space-y-5">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5">
              {filtered.map(o => (
                // OrderCard dengan badge orange untuk SIAP_KIRIM
                <Link key={o.id} href={`/dashboard/preparation/${o.id}`}
                  className={`block bg-white rounded-2xl border shadow-sm p-4 transition hover:shadow-md hover:border-gray-200 ${newIds.has(o.id) ? "border-orange-300 ring-2 ring-orange-200" : "border-gray-100"}`}>
