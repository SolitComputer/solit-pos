            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2.5 mb-1">
                  ...
                  <h1 className="text-xl sm:text-2xl font-black text-gray-900 tracking-tight">Leaderboard Lembur</h1>
                </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                ...
                <ResponsiveContainer width="100%" height={Math.max(220, barData.length * 34)}>
                  <BarChart data={barData} layout="vertical" margin={{ left: 8, right: 16, top: 4, bottom: 4 }}>
                    ...
                    <Bar dataKey="totalHours" fill="#7c3aed" radius={[0, 6, 6, 0]} barSize={16} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            ...
            {loading ? (
              ...
              <div className="divide-y divide-gray-50">
                {data.ranking.map((r, idx) => {
                  ...
                  return (
                    <div key={r.user_id} className="px-5 py-3.5 flex items-center gap-3.5">
