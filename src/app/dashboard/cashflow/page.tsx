...
export default function CashflowPage() {
    ...
    // Ganti 2 baris incomeToday dan incomeMonth yang ada
    const incomeToday = masuk.reduce(
        (s, e) => (e.source_type !== "MODAL_AWAL" && e.tanggal === jakartaToday ? s + Number(e.nominal || 0) : s),
        0
    );
    const incomeMonth = masuk.reduce(
        (s, e) => (e.source_type !== "MODAL_AWAL" && (e.tanggal || "").slice(0, 7) === monthPrefix ? s + Number(e.nominal || 0) : s),
        0
    );
