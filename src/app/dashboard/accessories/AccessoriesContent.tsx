                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden animate-slideUp">
                            <div className="overflow-x-auto table-scroll">
                                <table className="w-full text-sm border-collapse">
                                    <thead><tr className="bg-gray-50 border-b-2 border-gray-100"><Th center>No</Th><Th>Nama Aksesori</Th><Th>Kategori</Th><Th>Merk</Th><Th>Spek</Th><Th right>Harga Modal</Th><Th right>Harga Jual</Th><Th right>Gross Profit</Th><Th right>Stok</Th><Th right>Aksi</Th></tr></thead>                                    <tbody>
                                       {items.map((item, idx) => {
...
function SkeletonTable() {
    return (<div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden"><div className="overflow-x-auto"><table className="w-full text-sm"><thead><tr className="bg-gray-50 border-b-2 border-gray-100">{["No", "Nama Aksesori", "Kategori", "Merk", "Spek", "Modal", "Jual", "Gross Profit", "Stok", "Aksi"].map(h => (<th key={h} className="px-4 py-3"><Shimmer h={10} /></th>))}</tr></thead><tbody>{[1, 2, 3, 4, 5, 6].map(r => (<tr key={r} className="border-b border-gray-50"><td className="px-4 py-3.5"><Shimmer w={24} h={12} /></td><td className="px-4 py-3.5"><Shimmer w={150} h={13} /></td><td className="px-4 py-3.5"><Shimmer w={60} h={18} r="6px" /></td><td className="px-4 py-3.5"><Shimmer w={60} h={12} /></td><td className="px-4 py-3.5"><Shimmer w={90} h={12} /></td><td className="px-4 py-3.5"><div className="flex justify-end"><Shimmer w={80} h={13} /></div></td><td className="px-4 py-3.5"><div className="flex justify-end"><Shimmer w={80} h={13} /></div></td><td className="px-4 py-3.5"><div className="flex justify-end"><Shimmer w={70} h={13} /></div></td><td className="px-4 py-3.5"><div className="flex justify-end"><Shimmer w={26} h={22} r="8px" /></div></td><td className="px-4 py-3.5"><div className="flex justify-end gap-1.5"><Shimmer w={40} h={28} r="8px" /><Shimmer w={44} h={28} r="8px" /></div></td></tr>))}</tbody></table></div><div className="px-5 py-3.5 border-t border-gray-100 bg-gray-50/60"><Shimmer w={180} h={10} /></div></div>);
}