            ...
            try {
                ...
                const parsed = raw.map((row: any) => {
                    ...
                    return {
                        ...
                        status: statKey ? String(row[statKey]) : status,
                ...
                <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4 overscroll-contain">
                            ...
                            {snFrom && snTo && (
                                <div className="bg-gray-50 rounded-xl p-3 border border-gray-100">
                                    <p className="text-xs text-gray-500 mb-1">
                                        Total: <span className="font-bold text-gray-800">{generateRange(snFrom, snTo).length} unit</span>
                                    </p>
                    ...
                    {tab === "manual" && (
                        <div className="space-y-3">
                            <div className="bg-blue-50 border border-blue-100 rounded-xl p-3">
                                <p className="text-xs text-blue-700">
                                    Ketik atau paste serial number, satu per baris (atau pisahkan dengan koma).
                                </p>
                            </div>
                            <div>
                            ...
                            {excelRows.length > 0 && (
                                <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3">
                                    <p className="text-xs font-semibold text-emerald-700 mb-2">
                                        ✅ {excelRows.length} baris berhasil dibaca
                                    </p>
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-[10px]">
                                            ...
                                            <tbody>
                                                ...
                                                {excelRows.length > 5 && (
                                                    <tr>
                                                        <td colSpan={3} className="text-center pt-1 text-gray-400">
                                                            ... +{excelRows.length - 5} baris lagi
                                                        </td>
                                                    </tr>
                                                )}
                                            </tbody>
                    ...
                    {tab !== "excel" && (
                        <div className="border-t border-gray-100 pt-4 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full h-9 border border-gray-200 rounded-lg px-2 text-xs bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#1a1a2e]/20 transition"
                                    >
                            ...
                            <div>
                                <label className="block text-xs font-medium text-gray-500 mb-1.5">Kondisi (opsional)</label>
                                <input
                                    type="text"
                                    placeholder="Contoh: mulus, normal"
                                    value={conditionNote}
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                                ...
                                Tambah {unitCount > 0 ? `${unitCount} Unit` : "Unit"}
                            </>
                        )}
                    </button>
                </div>
...
export default function UnitsPage() {
    ...
    }, [filterStatus, filterGradeTab, searchSN]);
                        ...
                        {canManageUnits && (
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-1.5 px-3 py-2 bg-gray-600 rounded-lg text-sm font-medium text-gray-800 hover:bg-emerald-700 transition shadow-sm"
                                >
                                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex gap-1.5">
                            {[
                                ...
                                return (
                                    <button
                                        key={opt.value}
                                        onClick={() => setFilterGradeTab(opt.value)}
                                    ...
                                    >
                                        <span className={`text-[10px] font-medium leading-tight ${isActive ? "opacity-80" : "opacity-60"
                                            }`}>
                                            {opt.label}
                                        </span>
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-3 space-y-3">
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className={`inline-flex items-center gap-1.5 px-3 h-9 rounded-lg text-xs font-medium border transition ${showAdvancedFilter || filterPriceMin || filterPriceMax
                                    ? "bg-[#1a1a2e] text-white border-[#1a1a2e]"
                            ...
                            {hasActiveFilter && (
                                <button
                                    ...
                                    className="inline-flex items-center gap-1 px-2.5 h-9 rounded-lg text-xs font-medium text-red-500 border border-red-200 bg-red-50 hover:bg-red-100 transition"
                                >
                                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex items-center justify-between bg-red-50 border border-red-200 rounded-xl px-4 py-2.5">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="text-xs text-red-500 font-medium underline underline-offset-2 active:opacity-60 transition"
                                >
                                    Batal pilih
                                </button>
                                <button
                                            ...
                                            {canManageUnits && (
                                                <th className="px-4 py-3 w-14">
                                                    <button
                                                        ...
                                                        className={`w-4 h-4 rounded border-2 flex items-center justify-center transition flex-shrink-0 ${isAllSelected
                                                        ...
                                                        {(isAllSelected || isIndeterminate) && (
                                                            <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3}
                                                                    d={isIndeterminate ? "M5 12h14" : "M5 13l4 4L19 7"} />
                                                            </svg>
                                                        )}
                                                    </button>
                                                </th>
                                                    ...
                                                    {canManageUnits && (
                                                        <td className="px-4 py-3">
                                                            <button
                                                                ...
                                                                className={`w-4 h-4 rounded border-2 flex items-center justify-center transition flex-shrink-0 ${isSelected
                    ...
                    <div className="relative bg-white w-full max-w-md rounded-xl shadow-xl flex flex-col max-h-[85vh] overflow-hidden animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="overflow-y-auto flex-1 px-5 py-4">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-xs font-medium text-gray-500 mb-1.5">Catatan Kondisi</label>
                                    <input
                                        name="condition_note"
