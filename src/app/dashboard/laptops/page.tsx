                        ...
                        <div className="space-y-6">
                            <div className="flex flex-col sm:flex-row sm:items-start gap-5 p-5 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-100">
                                ...
                                <div className="sm:text-right flex-shrink-0">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{fmt(selectedLaptop.selling_price)}</p>
                                    <p className="text-xs text-gray-400 mt-1">
                                        Stok: <span className={`font-semibold ${selectedLaptop.qty === 0 ? "text-red-500" : "text-gray-700"}`}>{selectedLaptop.qty}</span>
                                    </p>
                                </div>
                            </div>
